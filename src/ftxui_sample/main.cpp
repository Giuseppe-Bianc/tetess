...
// configuration step. It creates a namespace called `tetess`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tetess::cmake::project_name, tetess::cmake::project_version) };
